...
LIBRARY_NAME := dbwrap
LIBRARY_SOURCES := DatabaseException.cpp Database.cpp Statement.cpp ParamBuffer.cpp Binary.cpp AdhocStatement.cpp AdhocParameter.cpp Julian.cpp IStatement.cpp
TEST_LIBRARY_SOURCES := UTFail.cpp TestNullable.cpp TestBinary.cpp TestDatabaseException.cpp TestDatabase.cpp TestImport.cpp TestJulian.cpp TestAdhocParameter.cpp
